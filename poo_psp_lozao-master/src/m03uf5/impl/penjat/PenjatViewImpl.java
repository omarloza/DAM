...
import m03uf5.impl.penjat.PenjatContract.PenjatView;

public class PenjatViewImpl implements PenjatView {
	...
	public PenjatViewImpl(Stage primaryStage) {
	...
	private void setStage(Stage primaryStage) {
		...
		vb.getChildren().addAll(comenzar, label, grid, reiniciar, turno, puntuacion);
	...
	@Override
	public void setPresenter(PenjatPresenter p) {
		this.presenter = p;
